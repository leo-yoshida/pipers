...
library(Cairo)
parb_barplot <- read.csv("E:/Doutorado_Destilado_2024/Papers_LQPN/Piper_RNASeq_dados/GITHUB/Top150_figures/arquivo_R_parb.txt", sep='\t')
pgau_barplot <- read.csv("E:/Doutorado_Destilado_2024/Papers_LQPN/Piper_RNASeq_dados/GITHUB/Top150_figures/arquivo_R_pgau.txt", sep='\t')
pmal_barplot <- read.csv("E:/Doutorado_Destilado_2024/Papers_LQPN/Piper_RNASeq_dados/GITHUB/Top150_figures/arquivo_R_pmal.txt", sep='\t')
ptub_barplot <- read.csv("E:/Doutorado_Destilado_2024/Papers_LQPN/Piper_RNASeq_dados/GITHUB/Top150_figures/arquivo_R_ptub.txt", sep='\t')

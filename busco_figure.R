...
my_species <- c('Piper arboreum', 'Piper arboreum', 'Piper arboreum', 'Piper arboreum', 'Piper gaudichaudianum', 'Piper gaudichaudianum', 'Piper gaudichaudianum', 'Piper gaudichaudianum', 'Piper malacophyllum', 'Piper malacophyllum', 'Piper malacophyllum', 'Piper malacophyllum', 'Piper tuberculatum', 'Piper tuberculatum', 'Piper tuberculatum', 'Piper tuberculatum')
...
my_percentage <- c(93.9, 2.8, 2.8, 0.5, 92.5, 3.8, 3.1, 0.6, 93.4, 3.8, 2.4, 0.4, 91.3, 3.3, 4.0, 1.4)
my_values <- c(399, 12, 12, 2, 393, 16, 13, 3, 397, 16, 10, 2, 388, 14, 17, 6)
...
figure <- ggplot() + 
  ...
  theme(axis.text.y = element_text(face= 'italic',family=my_family, colour = "black", size = rel(2)*my_size_ratio)) + 
  ...
  theme(axis.title.x = element_text(family=my_family, size=rel(1.7)*my_size_ratio)) + 
...
ggsave("myplot10_busco_cairo.png", width = my_width, height = my_height, unit = my_unit, type='cairo', dpi = 500)
